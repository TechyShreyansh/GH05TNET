...
NUMBER_OF_CLIENTS=$(grep -c -E "^### " "/etc/xray/vmessgrpc.json")
	if [[ ${NUMBER_OF_CLIENTS} == '0' ]]; then
		clear
		echo ""
		echo "You have no existing clients! by DARKBOY"
		exit 1
	fi

	clear
	echo ""
	echo "Select the existing client you want to renew by DARKBOY"
...
echo ""
echo "==============================="
echo " DARKBOY XRAY Vmess/Vless gRPC Account Renewed by DARKBOY  "
echo "==============================="
echo "Username  : $user"
echo "Expired   : $exp4"
echo "==============================="
